<template>
  <div class="main">
    ...
    <content-decorate style="margin-top: -20vh" :navigation="navigation">
      ...
      :image-urls="[
        'https://static.igem.wiki/teams/4627/wiki/hp/hp-1.png'
      ]"></text-with-image>
      <text-with-image
      :text-content="[
      ...
      :image-urls="[
        'https://static.igem.wiki/teams/4627/wiki/hp/hp-2.png'
      ]"></text-with-image>
      <text-with-image
      :text-content="[
      ...
      :image-urls="[
        'https://static.igem.wiki/teams/4627/wiki/hp/hp-3.jpg'
      ]"></text-with-image>
      <text-with-image
      sub-title="2.	Cheng Chen"
      :image-urls="[
        'https://static.igem.wiki/teams/4627/wiki/hp/hp-5.jpg'
      ]"></text-with-image>
      <text-with-image
      :text-content="[
      ...
      :image-urls="[
        'https://static.igem.wiki/teams/4627/wiki/hp/hp-6.png'
      ]"></text-with-image>
      <text-with-image
      :text-content="[
      ...
      :image-urls="[
        'https://static.igem.wiki/teams/4627/wiki/hp/hp-7.jpg'
      ]"></text-with-image>
      <text-with-image
      sub-title="4.	Jinhai Huang"
      :image-urls="[
        'https://static.igem.wiki/teams/4627/wiki/hp/hp-8.png'
      ]"></text-with-image>
      <text-with-image
      :text-content="[
      ...
      :image-urls="[
        'https://static.igem.wiki/teams/4627/wiki/hp/hp-10.jpg'
      ]"></text-with-image>
      <text-with-image
      :text-content="[
